  ...
  const rulesData = [
    ...
    { 
      ...
      items: [
        ...
        { text: '4.2. Аппеляция тюрьмы не рассматривается.', punishment: null },
...
function FaqPage() {
  const faqs = [
    ...
    { q: 'Как защитить свои постройки?', a: 'Используй команду /rg i для проверки привата. Если территория не привачена — она ничья.' },
    { q: 'Что делать если забанили/замутили?', a: 'Аппеляция тюрьмы не рассматривается. Соблюдай правила, чтобы избежать наказаний.' },
